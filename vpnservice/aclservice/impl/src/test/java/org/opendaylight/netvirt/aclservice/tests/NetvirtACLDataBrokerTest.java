...
public class NetvirtACLDataBrokerTest {
    ...
    @Test public void applyToPortWithSecurityEnabled() {
        InterfaceAcl acl1 = new InterfaceAclBuilder().setPortSecurityEnabled(true).setSecurityGroups(Collections.emptyList()).build();
        ...
        assertThat(aclService.applyAcl(port1)).isTrue();
        assertThat(mdsalApiManager.getFlows()).containsExactlyElementsIn(FlowEntryObjects.expectedFlows()).inOrder();
    }
