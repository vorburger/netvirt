...
public class NetvirtACLUnitTest {
    ...
    @Test public void compareFlowEntryWithEquals() {
        assertEquals(FlowEntryObjects.expectedFlows(), FlowEntryObjects.expectedFlows());
    }

    @Test public void compareFlowEntryWithToString() {
        assertEquals(FlowEntryObjects.expectedFlows().toString(), FlowEntryObjects.expectedFlows().toString());
    }
