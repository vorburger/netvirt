...
public abstract class TestDataBroker extends SimplestDatabase implements DataBroker {
    ...
    public static DataBroker newTestDataBroker() {
        TestDataBroker newnewTestDataBroker = Mikito.stub(TestDataBroker.class);
        newnewTestDataBroker.getMap(); // This initializes the SimplestDatabase
        return newnewTestDataBroker;
    }
